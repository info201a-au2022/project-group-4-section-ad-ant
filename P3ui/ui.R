...
plot1 <- tabPanel("Prison Rate",
                  ...
                  mainPanel(
                    plotlyOutput("plot1"),
                    p(strong("The Washington Association of Sheriffs and Police Chiefs (WASPC) compiles statistics on reported 
...
summ <- tabPanel("Summary",
                 ...
                 p("In the introduction, we mentioned that our goal is to figure out which part of Washington is safe or not. Thus, after exploring the data and visualizing it through 3 different charts. We have 3 takeaways:"),
                 p(""),
                 p("1. Snoqualmie is by far the safest city in Washington and Tacoma is considered as the most dangerous one."),
                 p("2. In terms of the prison rate, the fluctuations are mostly not obvious. However, there are 3 stagnant prison rates which are Benton, Clark, and Pierce."),
                 p("3. Last but not least, the county that has the most crime is Pierce."),
                 p("Therefore, these findings can make us more informed about the situation in Washington."),
                 p(""),
...
report <- tabPanel("Report",
                   ...
                   p(""),
                   h3("Authors"),
                   p("Alyssa Limit (alimit28@uw.edu) | Nathan Narayana (ibnn@uw.edu) | Thomas Emnetu (emnettho@uw.edu)"),
                   p(""),
                   h3("Affiliations"),
...
"),
                       ...
                       p(""),
                       p(strong("Here are the data files referenced in this project:")),
                       p("Criminal Justice Data Book | Observations: 1272 | Variables: 228"),
                       p("FBI: UCR | Observations: 37 | Variables: 12 "),
                       p(""),
